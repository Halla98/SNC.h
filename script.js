...
function drawCanvas(name = "") {
    ctx.clearRect(0, 0, canvas.width, canvas.height);  // مسح المحتوى القديم
    ctx.drawImage(img, 0, 0); // رسم الصورة في الخلفية
...
downloadBtn.addEventListener("click", function () {
    ...
    link.download = 'design_with_name.png';  // اسم الصورة عند تحميلها
